        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16 lg:py-24">
          ...
          <div className="space-y-8 sm:space-y-12">
            ...
            <section className="p-6 sm:p-8 rounded-2xl bg-slate-800/50 border border-slate-700/50 backdrop-blur-md shadow-xl">
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-6">AGREEMENT TO OUR LEGAL TERMS</h2>
              <div className="space-y-4 text-base sm:text-lg font-light text-slate-300 leading-relaxed">
                <p>We are Ace It AI (&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; &quot;our&quot;).</p>
                
                <p>We operate the website https://ace-it-ai-wine.vercel.app (the &quot;Site&quot;), as well as any other related products and services that refer or link to these legal terms (the &quot;Legal Terms&quot;) (collectively, the &quot;Services&quot;).</p>
                
                <p>You can contact us by email at amaantheone@gmail.com</p>
                
                <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity (&quot;you&quot;), and Ace It AI, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
            ...
            <section className="p-6 sm:p-8 rounded-2xl bg-slate-800/50 border border-slate-700/50 backdrop-blur-md shadow-xl">
              ...
              <ol className="list-decimal pl-6 space-y-2 text-base sm:text-lg font-light text-slate-300">
                <li>OUR SERVICES</li>
            ...
            {/* Our Services */}
            <section className="p-6 sm:p-8 rounded-2xl bg-slate-800/50 border border-slate-700/50 backdrop-blur-md shadow-xl">
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-6">1. OUR SERVICES</h2>
            ...
            <section className="p-6 sm:p-8 rounded-2xl bg-slate-800/50 border border-slate-700/50 backdrop-blur-md shadow-xl">
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-6">2. INTELLECTUAL PROPERTY RIGHTS</h2>
              <div className="space-y-6">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Your use of our Services</h3>
                  <div className="space-y-4 text-base sm:text-lg font-light text-slate-300 leading-relaxed">
                    ...
                    <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: amaantheone@gmail.com. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Your submissions</h3>
                  <div className="space-y-4 text-base sm:text-lg font-light text-slate-300 leading-relaxed">
            ...
            {/* Additional Terms */}
            <section className="p-6 sm:p-8 rounded-2xl bg-slate-800/50 border border-slate-700/50 backdrop-blur-md shadow-xl">
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-6">3-23. ADDITIONAL TERMS</h2>
              <p className="text-base sm:text-lg font-light text-slate-300 leading-relaxed">
                Please refer to our full Terms of Service document for sections 3-23, which cover User Representations, Registration, Purchases, Prohibited Activities, Contributions, Licenses, Social Media, Third-Party Content, Services Management, Privacy, Termination, Modifications, Governing Law, Dispute Resolution, Corrections, Disclaimers, Liability Limitations, Indemnification, User Data, Electronic Communications, and Miscellaneous provisions.
              </p>
            </section>
            ...
            <section className="p-6 sm:p-8 rounded-2xl bg-gradient-to-r from-slate-800/70 to-slate-700/70 border border-slate-600/50 backdrop-blur-md shadow-xl">
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-6">24. CONTACT US</h2>
              <div className="space-y-4 text-base sm:text-lg font-light text-slate-300 leading-relaxed">
          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-8 text-sm">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="transition-colors hover:text-blue-500 font-medium text-blue-500"
              >
                Terms of Service
              </a>
              <a 
